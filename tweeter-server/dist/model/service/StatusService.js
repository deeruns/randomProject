...
class StatusService {
    ...
    async getFakeData(lastItem, pageSize) {
        const [items, hasMorePages] = tweeter_shared_1.FakeData.instance.getPageOfStatuses(tweeter_shared_1.Status.fromDto(lastItem), pageSize);
    ...
    postStatus = async (token, newStatus) => {
