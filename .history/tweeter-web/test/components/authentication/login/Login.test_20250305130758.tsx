...
describe("Login Component", () => {
    ...
    it("calls the presenter's doLogin method when the sign-in button is clicked", async () => {
        ...
        registerLoginAndGetElements(originalUrl, mockPresenterInstance);
        await user.type(aliasField, alias)
        await user.type(passwordField, password);

        await user.click(signInButton);
        //expect method has been called on the presenter
        //we always do verifications on the mock, not the instance created from the mock
...
function expect(signInButton: HTMLElement) {
