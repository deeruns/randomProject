...
interface Props {
  originalUrl?: string;
  //pass in the presenter as a prop, so we can mock it
  presenter?: loginPresenter; //optional
}
...
const Login = (props: Props) => {
  ...
  // if props.presenter is null or undefined, create a new login presenter
