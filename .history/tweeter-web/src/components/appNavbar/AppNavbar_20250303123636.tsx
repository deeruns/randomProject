...
import { AppNavBarPresenter, LogoutView } from "../../presenter/AppNavBarPresenter";
import useToastListener from "../toaster/ToastListenerHook";

const AppNavbar = () => {
  const location = useLocation();
  const { userAuthToken, clearUser } = useInfo();
  ...
  const logOut = async () => {
    presenter.logOut(userAuthToken!);
  };

  // go to user service and logout presenter
  // const logout = async (userAuthToken: AuthToken): Promise<void> => {
